        ...
        <div>
            {buttonText === "checkbox" ?
                ...
                <div
                    ...
                    className="items-baseline mt-2 p-1 bg-[#8F2C8C] hover:bg-[#6F1D6C] transition-colors duration-200 rounded-md cursor-pointer"
                >
                    <div className="mx-auto w-36 rounded-md flex flex-row gap-x-2 justify-center items-center">
